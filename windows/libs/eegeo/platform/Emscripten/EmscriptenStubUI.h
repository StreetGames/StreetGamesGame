...
namespace Eegeo
{
    ...
    {
        class EmscriptenAlertBoxFactory : public UI::NativeAlerts::IAlertBoxFactory
        {
        ...
        class EmscriptenInputBoxFactory : public UI::NativeInput::IInputBoxFactory
        {
        ...
        class EmscriptenKeyboardInputFactory : public UI::NativeInput::IKeyboardInputFactory
        {
