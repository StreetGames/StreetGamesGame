...
namespace Eegeo
{
    ...
    {
        class EmscriptenConnectivityService: public Web::IConnectivityService, private Eegeo::NonCopyable
        {
        public:
            EmscriptenConnectivityService();
            
            bool HasConnectivity();
            Web::ConnectivityType GetConnectivityType();
            
            const std::string& GetSSIDForCurrentWifi();
