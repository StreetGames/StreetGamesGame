    ...
    namespace Camera
    {
        namespace GlobeCamera
        {
            ...
            public:
                ...
                virtual float GetZoomVelocity() const { return m_zoomVelocity; }
                ...
                virtual bool IsPanning() const { return m_panning; }
                virtual bool IsTilting() const { return m_tilting; }
            ...
            private:
                ...
                Eegeo::v2 m_tiltOriginalExtents;
