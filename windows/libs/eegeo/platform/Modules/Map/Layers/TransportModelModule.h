        ...
        namespace Map
        {
            namespace Layers
            {
                ...
                public:
                    ...
                    Rendering::Scene::SceneElementRepository<Rendering::Renderables::TextRenderable>& GetRoadNamesSceneElementRepository() const;
                ...
                private:
                    ...
                    Rendering::Scene::SceneElementRepository<Rendering::Renderables::TextRenderable>* m_pRoadNamesSceneElementRepository;
