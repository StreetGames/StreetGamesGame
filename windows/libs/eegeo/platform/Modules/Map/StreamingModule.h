...
namespace Eegeo
{
    namespace Modules
    {
        namespace Map
        {
            ...
            {
            public:
                StreamingModule(Eegeo::Web::IWebLoadRequestFactory& webLoadRequestFactory,
                                ...
                                Eegeo::Rendering::AsyncTexturing::HttpAsyncCubeTextureLoader& httpAsyncCubeTextureLoader,
