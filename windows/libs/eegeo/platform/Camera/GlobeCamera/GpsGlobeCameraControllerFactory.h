    ...
    namespace Camera
    {
        namespace GlobeCamera
        {
            ...
            public:
				...
				GpsGlobeCameraController* Create(const GpsGlobeCameraComponentConfiguration& gpsGlobeCameraConfig,
                                                 GlobeCameraTouchController& touchController,
                                                 const GlobeCameraControllerConfiguration& globeCameraConfiguration,
                                                 const Eegeo::Rendering::ScreenProperties& screenPropertie);
