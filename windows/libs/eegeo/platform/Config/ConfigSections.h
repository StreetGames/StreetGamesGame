...
namespace Eegeo
{
    namespace Config
    {
        static const std::string CoverageTreeManifestUrlDefault = "http://cdn1.eegeo.com/coverage-trees/vglobal/v1350/manifest.bin.gz";

        static const std::string CityThemesManifestUrlDefault   = "http://d2xvsc8j92rfya.cloudfront.net/mobile-themes-new/v784/manifest.bin.gz";
        ...
        struct CityThemesConfigSection
        {
            ...
            , EmbeddedThemeManifestFile("embedded_manifest.bin")
            , EmbeddedThemeTexturePath("EmbeddedTheme")
        ...
        struct MapLayersConfigSection
        {
            ...
            Eegeo::Modules::Core::FontsModuleConfiguration FontsModuleConfig;
            Eegeo::Modules::Core::DebugRenderingModuleConfiguration DebugRenderingModuleConfig;
            Eegeo::Labels::LabelsModuleConfiguration LabelsModuleConfig;
            
            MapLayersConfigSection()
            : Interiors(Modules::Map::Layers::InteriorsPresentationModule::DefaultConfig())
            , FontsModuleConfig(Eegeo::Modules::Core::FontsModule::DefaultConfig())
            , DebugRenderingModuleConfig(Eegeo::Modules::Core::DebugRenderingModule::DefaultConfig())
            , LabelsModuleConfig(Labels::LabelsModule::DefaultConfig())
            {
