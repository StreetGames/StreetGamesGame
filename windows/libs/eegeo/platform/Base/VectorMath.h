...
{	
    ...
    inline bool v2::operator== (const v2 &rhs) const
    {
    ...
    inline bool v4::operator== (const v4 &rhs) const
    {
    ...
    inline m44 m44::CreateTranslate(const v3& translate)
    {
        m44 m(CreateIdentity());
        m.m_rows[3] = v4(translate, 1.f);
        return m;
    }
    
    inline m44 m44::CreateScale(const v3& scale)
    {
        m44 m;
        m.Scale(scale);
        return m;
    ...
    {
        m_rows[0].Set(right.x, right.y, right.z, 0.f);
        m_rows[1].Set(up.x, up.y, up.z, 0.f);
        m_rows[2].Set(forward.x, forward.y, forward.z, 0.f);
        m_rows[3].Set(pos.x, pos.y, pos.z, 1.f);
    }
    ...
    inline bool m44::operator== (const m44 &rhs) const
    {
