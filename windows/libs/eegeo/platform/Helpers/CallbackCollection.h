...
namespace Eegeo
{
    namespace Helpers
    {
        ...
        {
        public:
            void ExecuteCallbacks(TItem& item) const
            {
        ...
        {
        public:
            void ExecuteCallbacks(TItem1& item1, TItem2& item2) const
            {
        ...
        {
        public:
            void ExecuteCallbacks(TItem1& item1, TItem2& item2, TItem3& item3) const
            {
