...
namespace Eegeo
{
    namespace Helpers
    {
        namespace TextureNameHelpers
        {
            ...
            const std::string GetCubeTextureExtension(const std::string& textureName);
            const std::string GetMultiFileCubeTextureExtension(const std::string& textureName);
            std::string StripLastExtension(const std::string& textureName);
            bool GetPlatformSupportsSingleFileCubeMaps(const std::string& textureName);
