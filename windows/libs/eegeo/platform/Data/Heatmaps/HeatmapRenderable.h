    ...
    namespace Data
    {
        namespace Heatmaps
        {
            ...
            public:
                ...
                void SetHeatmapTextureId(const Rendering::TTextureId& heatmapTextureId) { m_heatmapTextureId = heatmapTextureId; }
                void SetGradientTextureId(const Rendering::TTextureId& gradientTextureId) { m_gradientTextureId = gradientTextureId; }
