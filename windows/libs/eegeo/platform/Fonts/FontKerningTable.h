...
namespace Eegeo
{
    namespace Fonts
    {
        ...
        public:
            ...
            void AddPair(u32 firstUnicode, u32 secondUnicode, float kerningValue);
            bool TryGet(u32 firstUnicode, u32 secondUnicode, float& out_kerningValue) const;
        private:
            ...
            typedef Eegeo::unordered_map<u64, float>::type TPairKeyToKerningValues;
