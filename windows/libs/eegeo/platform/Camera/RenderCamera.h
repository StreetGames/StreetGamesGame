...
namespace Eegeo
{
    namespace Camera
    {
        ...
        public:
            ...
            //! Project a camera-relative Ecef point to screenspace, where screen plane points behind the camera are projected
            //! onto a plane just in front before the perspective is applied. 
            //! \param cameraRelativeWorldPosition point in ECEF coordinate frame, with translation relative to camera origin
            //! \param screenPosition [out] projected position in screenspace
        ...
        private:
            ...
            void ClipSpaceToScreenSpace(const Eegeo::v4& clipPosition, Eegeo::v3& screenPosition) const;
        };
    }
}