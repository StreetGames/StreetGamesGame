...
#define EEGEO_PLATFORM_VERSION_NUMBER "854"
#define EEGEO_PLATFORM_VERSION_HASH "3066000a1f8cda50c9e748879232f4a7ae3e0fdc"
...
namespace Eegeo
{
    ...
    private:
        ...
        const Eegeo::Config::PlatformConfig m_platformConfig;
    ...
    public:
        ...
        Eegeo::Concurrency::Tasks::IWorkPool& GetWorkPool() { return m_workPool; }
